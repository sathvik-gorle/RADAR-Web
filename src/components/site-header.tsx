                    ...
                    <div className={"flex items-center justify-between md:border md:p-2.5 md:rounded-xl max-w-2xl mx-auto md:backdrop-blur "}>
                        ...
                        <section className={"max-md:hidden"}>
                            <nav className={"flex gap-8 items-center text-sm"}>
                                <Link href={"#"} className={"text-white/70 hover:text-white transition"}>Image Detection</Link>
                                <Link href={"#"} className={"text-white/70 hover:text-white transition"}>Analysis</Link>
                                <Link href={"#"} className={"text-white/70 hover:text-white transition"}>Risk Assesment</Link>
                            </nav>
                        </section>
                        <section className={"flex max-md:gap-4 items-center"}>
                            <ActionButton label={"Check Damage Now"} />
